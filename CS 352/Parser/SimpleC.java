...
System.out.println("RPARENT, \u005c""+t.image+"\u005c"" ); count++;
      ...
      case LSQUARE:{
        t = jj_consume_token(LSQUARE);
System.out.println("LSQUARE, \u005c""+t.image+"\u005c"" ); count++;
        break;
        }
      case RSQUARE:{
        t = jj_consume_token(RSQUARE);
System.out.println("RSQUARE, \u005c""+t.image+"\u005c"" ); count++;
        break;
        }
      case LCURLY:{
...
System.out.println("ASSIGN, \u005c""+t.image+"\u005c"" ); count++;
        break;
        }
      case AMPERSAND:{
...
{if ("" != null) return count;}
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x7f000,0x80000400,0x80000000,0x7f000,0x80000000,0x7f000,0x8000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x400,0x8000000,0x400,0x400,0x27eff000,0x80000000,0x8000400,0x27eff000,0x100000,0x7000000,0xfffffc00,0xfffffc00,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x8,0x10,0x60,0x60,0x780,0x780,0x1800,0x1800,0xe000,0xe000,0x3804,0x1d3804,0x0,0x0,0x1d0000,0x10000,0x0,0x2,0x10000,0x0,0x0,0x7ffffff,0x7ffffff,};
   }
